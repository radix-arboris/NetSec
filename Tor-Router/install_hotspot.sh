...
wifi_static_ip="192.168.4.1"
wifi_range_1="192.168.4.2"
wifi_range_2="192.168.4.20"
ssid="Tour_Devel"
passphrase="toortoor"
...
echo "interface wlan0
    static ip_address=${wifi_static_ip}/24
...
dhcp-range=${wifi_range_1},${wifi_range_2},255.255.255.0,24h" > /etc/dnsmasq.conf
